...
const Navbar = () => {
  ...
  return (
    <header className="h-headerHeight z-50 text-textColor bg-blend-multiply bg-headerColor shadow-sm  flex items-center sticky top-0">
      <nav className="sm:px-10 px-4 flex w-full h-full items-center justify-between">
        <Link to="/">
          {" "}
          <h3 className=" font-dancingScript text-logoText">Sticky Notes</h3>
        </Link>
        <ul
